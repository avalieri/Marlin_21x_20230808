...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    // Recv: echo:  M301 P22.92 I1.94 D67.85
...
#define PIDTEMPBED
  ...
  // Recv: echo:; Bed PID:
  // Recv: echo:  M304 P84.63 I13.92 D343.04
  #define DEFAULT_bedKp 84.63
  #define DEFAULT_bedKi 13.92
  #define DEFAULT_bedKd 343.04
...
// Recv: echo:  M92 X80.00 Y80.00 Z400.00 E97.70
...
// Recv: echo:  M203 X500.00 Y500.00 Z10.00 E60.00 (E60 for BMG extruder, 25 for Creality extruder)
...
// Recv: echo:  M851 X-42.00 Y-5.00 Z-1.42 ; (mm)
#define NOZZLE_TO_PROBE_OFFSET { -42.00, -5.00, -1.42 }
